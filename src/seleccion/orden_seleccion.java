...
public class orden_seleccion {
    ...
    public void numeros(){
        ...
        metod.ordenamiento_seleccion(numeros, ascendente);
    ...
    public void cadenas(){
        ...
        metod.ordenamiento_seleccion(nombres,ascendente);
    ...
    public void objetos(){
        ...
        if (criterio == 1) {
            metod.metodoSeleccion(personas, ascendente);
        } else if (criterio == 2) {
            metod.metodoSeleccion(personas, ascendente, new Comparator<persona>() {
                @Override
