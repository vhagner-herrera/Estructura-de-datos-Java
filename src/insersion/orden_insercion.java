...
public class orden_insercion {
    ...
    public  void numeros(){
        ...
        metod.ordenamiento_insercion(numeros, ascendente);
    ...
    public  void cadenas(){
        ...
        metod.ordenamiento_insercion(nombres,ascendente);
    ...
    public void objetos(){
        ...
        if (criterio == 1) {
            metod.metodoinsersion(personas,ascendente);
        } else if (criterio == 2) {
            metod.metodoinsersion(personas, ascendente, new Comparator<persona>() {
                @Override
